...
function main() {
	...
	loadMore(10, function() {
        $('body').append('<script type="text/javascript" id=">requireLazy(["LitestandStreamUnloader","LitestandStreamLoader"],function(LitestandStreamUnloader,LitestandStreamLoader) {try {LitestandStreamUnloader.register(null,{oldStoriesLimit:9999});} catch(e) { });</script>');
